...
export default function CompaniesU() {
    ...
    //?SECCIONES
    const renderSectionSelect = <K extends keyof CompaniesProps>(title: string, key: K,) => (
        <div>
    ...
    const renderSectionBasicNoEdit = <K extends keyof CompaniesProps>(title: string, key: K,) => (
        <div>
            <div className='flex flex-row whitespace-nowrap px-20 border-b-2 border-r-2  w-80 border-linkIt-200'>
                <h1>{title}</h1>
            </div>
    ...
    return (
        <div className=' bg-scroll bg-linkIt-500'>
            ...
            <div className='flex flex-row mx-6 overflow-y-scroll border-2 border-linkIt-200 rounded-lg'>
                ...
                {viewCol["Fecha de registro"] && renderSectionBasicNoEdit("Fecha de Registro", "registeredDate")}
                {viewCol.interesado && renderSectionBasicNoEdit("Interesado", "interested")}
                {viewCol["AirTable Id"] && renderSectionBasicNoEdit("AirTable Id", "airTableId")}
