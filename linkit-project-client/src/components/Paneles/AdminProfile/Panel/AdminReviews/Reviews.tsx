...
import { setReviews, sortReviews } from "../../../../../redux/features/ReviewsSlice";
...
export default function Reviews() {
    ...
    const data = useSelector((state: stateProps) => state.reviews.filteredReviews);
    ...
    //?
    //?SECCIONES
    const renderSectionSelect = <K extends keyof ReviewProps>(title: string, key: K,) => (
        <div>
    ...
    const renderSectionBasicNoEdit = <K extends keyof ReviewProps>(title: string, key: K,) => (
        <div>
            <div className='flex flex-row whitespace-nowrap px-20 border-b-2 border-r-2  w-80 border-linkIt-200'>
                <h1>{title}</h1>
            </div>
