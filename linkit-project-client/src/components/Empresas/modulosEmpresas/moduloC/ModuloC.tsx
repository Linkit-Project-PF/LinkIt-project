...
export default function ModuloC() {
    ...
    return (
      <div className="relative flex flex-col items-center pb-3">
        <h1 className="font-bold text-2xl xl:text-3xl 2xl:text-4xl mt-7 mb-5">Más de 500 empresas confían en LinkIT</h1>
        <div className="flex flex-row space-x-10">
        <button className="" onClick={handlePrev}> <img className='h-5 rotate-90 ' src={arrow} alt="prev" /></button>
        <div className="w-[50rem] xl:w-[55rem] 2xl:w-[65rem] flex flex-row justify-center mb-10 xl:mb-12 2xl:mb-24">
