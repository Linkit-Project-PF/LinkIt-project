            ...
            <div className=''>
                <div className="skewed-borderBH hidden lg:block dark:bg-white p-[7%]">
                    <div className="contentBH flex flex-col pb-[10%] ">
                        <h1 className="text-white titles-size text-center justify-center font-manrope mb-[5%] font-bold">{t('Nuestros servicios')}</h1>
                            <div className="">
                                <div className='grid grid-cols-3 mb-[3%] ml-[10%]'>
                                <h2 className="text-white font-bold subtitles-size font-manrope text-start">{t('Reclutamiento')} <br /> {t('y selección')} </h2>
                                ...
                                <h2 className="text-white font-bold subtitles-size font-manrope text-start ">{t('Contratación')}</h2>
                            ...
                            <div className='grid grid-cols-3 ml-[10%] mt-[3%]'>
                                <h2 className="text-white font-bold subtitles-size font-manrope text-start ">{t('Gestión')} <br /> {t('y beneficios')}</h2>
