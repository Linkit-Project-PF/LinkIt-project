...
export default function ModuloG() {
  ...
  return (
    <div className="bg-linkIt-500 p-[7%] dark:bg-linkIt-200 dark:text-white">
      <h3 className="font-bold grid col-span-4 titles-size text-center mb-[5%] font-manrope">
        {t("¿Por qué elegir LinkIT?")}
      </h3>
      ...
      <div>
        ...
        <p className="text-center text-size font-montserrat">
          {t("candidatos listos para")}
          <br /> {t("trabajar")}
        </p>
        <p className="text-center text-size font-montserrat">
          {t("tipos de lenguajes en los ")} <br />
          {t("que nos especializamos")}
        </p>
        <p className="text-center text-size font-montserrat">
          {t("para contactar a tu")} <br /> {t("próximo talento")}
        </p>
        <p className="text-center text-size font-montserrat">
          {t("para seleccionar ")}
          <br /> {t("talentos")}
      ...
      <div className="lg:hidden flex justify-center items-center space-x-4 xs:space-x-10">
        <img
          ...
          className=" w-[20px] rotate-90 cursor-pointer"
          onClick={handlePrev}
          alt="arrow"
        />
