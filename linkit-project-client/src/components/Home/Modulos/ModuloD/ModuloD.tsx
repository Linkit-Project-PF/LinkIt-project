    ...
    return (
        <div className="grid grid-cols-2 bg-linkIt-500 p-[6%]">
            ...
            <div className='grid'>
                ...
                <div className='relative division w-[100%] before:absolute before:left-[100%]'></div>
                ...
                <div className='relative division w-[100%] before:absolute before:left-[100%] col-start-2'></div>
            </div>
    )
}
