...
export default function ModuloD() {
    ...
    return (
        <div className="grid grid-cols-2 bg-linkIt-500 p-[6%]">
            ...
            <div className='grid'>
                ...
                <div className='relative division w-[100%] before:absolute before:left-[95%] 2xl:before:left-[97%]'></div>
                ...
                <div className='relative division w-[100%] before:absolute before:left-[95%] 2xl:before:left-[97%] col-start-2'></div>
            </div>
    )
}
