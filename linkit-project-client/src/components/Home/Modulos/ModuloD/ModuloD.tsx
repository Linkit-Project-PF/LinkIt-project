    ...
    return (
        <div className="grid grid-cols-2 bg-linkIt-500 dark:bg-linkIt-400 dark:text-white p-[6%]">
            ...
            <div className='grid'>
                ...
                <div className='relative division w-[100%] before:absolute before:left-[100%] before:top-[50%]'></div>
                ...
                <div className='relative division w-[100%] before:absolute before:left-[100%] before:top-[50%] col-start-2'></div>
            </div>
    )
}
