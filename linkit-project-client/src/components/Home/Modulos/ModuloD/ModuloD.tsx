                ...
                <ul>
                    <div className='flex flex-row '>
                        ...
                        <div className='flex flex-col justify-center lg:my-6 xl:my-4'>
                            ...
                            <p className='text-[10px] p-1 md:text-[13px] lg:text-sm xl:text-base xl:py-4 2xl:text-lg xl:p-0'>En 5 días hábiles presentaremos talentos previamente entrevistados y calificados.</p>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-row'>
                        ...
                        <div className='flex flex-col justify-center lg:my-6 xl:my-4'>
                            ...
                            <p className='text-[10px] p-1 md:text-[13px] lg:text-sm xl:text-base xl:py-4 2xl:text-lg xl:p-0'>Nos comprometemos a mantener una comunicación ágil y efectiva durante todo el proceso de selección.</p>
                        </div>
                    </div>
                    <div className='division'></div>
                    ...
                    <div className='flex flex-row'>
                        ...
                        <div className='flex flex-col justify-center lg:my-6 xl:my-4'>
                            ...
                            <p className='text-[10px] p-1 md:text-[13px] lg:text-sm xl:text-base xl:py-4 2xl:text-lg xl:p-0'>Te asesoramos desde el perfil ideal, los presupuestos idóneos y procesos de contratación hasta planes de beneficios, retención y mucho más.</p>
                        </div>
                    </div>
                    <div className='division'></div>
                </ul>
