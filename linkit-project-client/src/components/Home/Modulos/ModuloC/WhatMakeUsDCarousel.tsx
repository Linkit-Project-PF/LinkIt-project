...
export default function WhatMakeUsDCarousel() { 
    ...
    return ( 
        <div className="">
            ...
            <img className="relative top-[1.2rem] rotate-180 w-[20px]" onClick={handlePrev} src={grayArrow} alt="gray-Arrow" />
            <div className="mt-5">
            ...
            <img className="relative top-5 w-[20px]" onClick={handleNext} src={grayArrow} alt="gray-Arrow" />
            </div>
