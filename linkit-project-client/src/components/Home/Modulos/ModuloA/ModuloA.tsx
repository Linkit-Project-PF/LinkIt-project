  ...
  return (
    <div className="grid grid-cols-2 gap-1 bg-linkIt-500 pt-24 pl-2 md:pl-6 md:pt-24 lg:p-14 lg:pt-36 xl:pt-38 xl:p-30 xl:pb-24 2xl:pb-24 h-[95vh]">
      <div className="flex flex-col justify-center md:mx-2 lg:mx-4 xl:mx-6 2xl:ml-12 2xl:mt-24">
        <h1 className="text-sm font-bold md:text-2xl lg:text-4xl xl:text-5xl 2xl:text-8xl font-manrope">Conectando al talento más destacado con los mejores proyectos IT</h1>
        <div className="my-1 md:my-2 lg:my-6 xl:my-6 2xl:pr-32 2xl:mt-12">
          <h3 className="text-xs md:text-base lg:text-[1.1rem] xl:text-[1.5rem] 2xl:text-5xl">Contrata y gestiona al mejor talento de manera global</h3>
        </div>
        <div className="flex 2xl:mt-2 h-[5vh]">
          ...
          <motion.button className="border-linkIt-300 border rounded-[7px] 2xl:rounded-xl p-1 h-[100%] lg:w-[28%] 2xl:w-[20%] shadow-md hover:bg-linkIt-300 hover:shadow-md hover:text-white transition-all duration-300 ease-in-out m-1 text-xs md:text-sm lg:text-xs xl:text-sm 2xl:text-xl" onClick={goSoyTalento} whileTap={{ scale: 0.9 }}>Vacantes disponibles</motion.button>
        </div>
