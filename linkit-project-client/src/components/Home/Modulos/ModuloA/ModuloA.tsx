  ...
  return (
    <div className="grid grid-cols-2 h-fit w-screen overflow-hidden bg-linkIt-500 dark:bg-linkIt-200 dark:text-white p-[7%] lg:p-[6%] pt-[17vh] lg:pt-[23vh] pb-[13%] ">
       <div className="space-y-[5%] ">
        ...
        <img className="relative self-end bottom-2 xs:bottom-0 xs:left-5 xs:top-3 md:top-16 lg:top-14" src="/Vectores/1-linkit-ilustracion-home-SVG.svg" alt="computer" />
      </div>
  )
}
