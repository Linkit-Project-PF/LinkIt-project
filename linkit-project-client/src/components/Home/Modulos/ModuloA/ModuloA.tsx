...
export default function ModuloA() {
  ...
  return (
    <div className="grid grid-cols-2 h-fit w-screen overflow-hidden bg-linkIt-500 dark:bg-linkIt-200 dark:text-white p-[7%] lg:p-[6%] pt-[38%] ssm:pt-[28%] md:pt-[26%] lg:pt-[13%] pb-[13%] ">
