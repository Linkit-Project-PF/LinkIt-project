...
export default function ModuloA() {
  ...
  return (
    <div className="grid grid-cols-2 h-fit w-screen overflow-hidden bg-linkIt-500 dark:bg-linkIt-200 dark:text-white p-[7%] pt-[17vh] lg:pt-[17vh] ">
       <div className="space-y-[5%] mr-10 ">
        ...
        <img className="relative self-end bottom-5 w-[90%] xl:-mt-8 left-[15%] xs:left-[30%] xs:w-[80%] ssm:w-[90%] ssm:bottom-0 ssm:left-[15%] lg:top-10 lg:w-[85%]  lg:left-[16%]" src="/Vectores/linkit-slider-home.png" alt="computer" />
      </div>
  )
}
