...
export default function ModuloG() {
    return (
        <div className="xl:px-36">
            <h1 className="flex justify-center text-sm m-6 md:text-2xl lg:text-3xl lg:my-12 xl:text-4xl xl:m-16 2xl:text-5xl 2xl:m-24">Talento especializado en más de 100 tecnologías</h1>
