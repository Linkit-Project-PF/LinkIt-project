...
export default function ModuloB() { 
    ...
    return ( 
        <div className="bg-linkIt-500 grid grid-cols-2 gap-[28vw] p-[6vw] dark:bg-linkIt-400 ">
            ...
            <p className="text-black self-end after:block after:bg-linkIt-300 dark:after:bg-white after:h-[2px] after:w-[30vw] text-end text-[1.1vw] dark:text-white">{t('Nuestra Visión')}</p>
        </div>
    ) }