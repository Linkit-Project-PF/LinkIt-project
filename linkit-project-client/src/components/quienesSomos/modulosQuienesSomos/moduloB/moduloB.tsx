...
export default function ModuloB() { 
    ...
    return ( <div>
        ...
        <div className="bg-linkIt-500 lg:flex p-[7%] dark:bg-linkIt-400 h-full ">
            ...
            <p className="text-black relative text-[0.6rem] ssm:text-[1rem] dark:text-white mt-3">{t('Nuestra Visión')}</p>
            </div>
        </div>
        </div>
