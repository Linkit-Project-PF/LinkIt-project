    ...
    return (
        <div className="relative grid p-[7%] z-[10] bg-white dark:bg-linkIt-300">
            ...
            <div className="grid grid-cols-4 grid-rows-1 items-center justify-items-center my-[5%] gap-[5%] mx-[5%] dark:text-white" >
                ...
                <Link target="_blank" to="https://www.linkedin.com/in/philippesainthubert/" className="text-center font-bold subtitles-size font-montserrat">Philippe Saint-Hubert <br /><span className="font-normal text-size  font-montserrat">Co-Founder</span></Link>
                ...
                <Link target="_blank" to="https://www.linkedin.com/in/gonzalo-leon-744aa01a1/" className="text-center font-bold subtitles-size font-montserrat">Gonzalo Lein<br /><span className="font-normal text-size  font-montserrat">Sales Development Representative</span></Link>
