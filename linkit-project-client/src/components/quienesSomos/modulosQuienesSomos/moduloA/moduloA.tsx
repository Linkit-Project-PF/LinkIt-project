...
export default function ModuloA() {
    ...
    return (
        <div className="bg-linkIt-200 flex flex-col lg:grid lg:grid-cols-2 p-[7%] pb-[2%] pt-[20vh] lg:pt-[23vh] items-center">
            <div className="">
            <h3 className="text-white text-[1.2rem] ssm:text-[2rem] lg:text-[1.5rem] xl:text-[2rem] 1xl:text-[2.5rem]  font-manrope font-bold tracking-wide leading-tight">{t('En LinkIT buscamos conectar al talento más destacado con los mejores proyectos de tecnología de manera global.')}</h3>
