...
export default function ModuloA() {
    ...
    return (
        <div className="bg-linkIt-200 h-screen grid grid-cols-2 p-[6vw]">
            <div>
            <h1 className="text-white text-[2.6vw] mt-[13vh] font-manrope font-bold tracking-wide">{t('En LinkIT buscamos conectar al talento más destacado con los mejores proyectos de tecnología de manera global.')}</h1>
