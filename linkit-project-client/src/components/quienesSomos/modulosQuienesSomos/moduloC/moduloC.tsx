...
<p className="text-black dark:text-white after:block after:bg-linkIt-300 dark:after:bg-white after:h-[2px] after:w-[25vw] text-[1.1vw] after:ml-[5vw] text-end self-end">{t('Nuestros Valores')}</p>
