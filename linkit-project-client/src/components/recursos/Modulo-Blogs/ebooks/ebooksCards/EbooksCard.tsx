...
function EbooksCard({
  ...
  return (
    ...
    >
      <div>
        <p className="border-[2px] text-[0.8rem] mb-[1rem] h-[25px] lg:h-[10px] border-linkIt-300 rounded-[10px] p-[0.8rem] lg:p-[0.7rem] font-semibold items-center justify-center whitespace-nowrap inline-flex lg:text-[0.7rem]">
          {category}
        </p>
        <h1 className="font-bold text-[1.3rem] w-[100%] mb-[0.9rem] lg:text-[1rem] lg:mt-[0.5rem]">{title}</h1>
        <p className="font-semibold text-[0.8rem] mb-[1.5rem] xl:mb-[-1rem]">{description}</p>
      </div>
      <motion.a 
      href={link} 
