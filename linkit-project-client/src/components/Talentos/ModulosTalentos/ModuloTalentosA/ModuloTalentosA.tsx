    ...
    <div className="grid grid-cols-2 gap-1 bg-linkIt-500 pt-24 pl-2 md:pl-6 md:pt-24 lg:p-14 lg:pt-36 xl:pt-38 xl:p-30 xl:pb-24 2xl:pb-24 h-[95vh]">
      <div className="flex flex-col justify-center md:mx-2 xl:mx-6 2xl:ml-12 2xl:mt-24">
        ...
        <div className="flex flex-row items-center">
          ...
          <h4 className="flex text-[9px] md:text-xs xl:text-lg 2xl:text-lg mb-4">4/5 on Trustpilot <Link to='https://es.trustpilot.com/review/linkit-hr.com' target="_blank" className="underline ml-2 font-semibold">Leer reviews</Link></h4>
        </div>
      </div>
      <div>
