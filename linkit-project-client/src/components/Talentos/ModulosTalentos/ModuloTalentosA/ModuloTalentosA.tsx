...
export default function ModuloTalentosA() {
  ...
  return (
    <div className="bg-linkIt-500 dark:bg-linkIt-200 dark:text-white h-full pt-[19vh] ssm:pt-[21vh] md:pt-0">
      ...
      <div className="grid grid-cols-2 h-fit w-screen overflow-hidden bg-linkIt-500 dark:bg-linkIt-200 dark:text-white md:pt-[19vh] ">
        <div className="sm:mt-[5%] md:space-y-[5%]  pl-[6%] min-[300px]:ml-[7px] min-[350px]:ml-2 min-[450px]:ml-3 min-[500px]:ml-3 ssm:ml-4">
          ...
          <h3 className="hidden md:block font-monserrat text-[0.8rem] lg:text-[1.5rem] md:text-[1.4rem] xl:text-[1.8rem] 2xl:text-[2.5rem] w-[110%] ssm:w-[89%] sm:w-[120%]  lg:w-[90%] xl:w-[85%] leading-tight">
          ...
          <div className="hidden md:block relative flex top-3">
            <img
        ...
        <img
          className="2xl:w-[93%] 2xl:h-[100%] 2xl:ml-12 2xl:mt-0 2xl:bottom-0  xl:w-[90%] xl:ml-6 lg:w-[100%] lg:h-[100%] xs:h-[95%] xs:w-[87%] sm:h-[95%] sm:w-[88%] w-full h-auto md:px-4 min-[400px]:ml-1 min-[450px]:ml-2 ssm:ml-3 ssm:h-[95%] ssm:w-[88%] xs:self-end  md:self-auto  ssm md:mt-[15%] xl:mt-6"
