...
<div className="grid grid-cols-2 h-fit w-screen overflow-hidden bg-linkIt-500 dark:bg-linkIt-200 dark:text-white  pt-[17vh] lg:pt-[17vh] ">
 <div className="space-y-[5%] p-[7%]">
      ...
      <img className="relative self-end content-end w-[90%] left-[15%] xs:left-[30%] xs:w-[80%] ssm:w-[90%] ssm:bottom-0 ssm:left-[15%] lg:w-[85%] lg:left-[16%]" src="/Vectores/linkit-slider-talento.png" alt="computer" />
      </div>
  )
}
