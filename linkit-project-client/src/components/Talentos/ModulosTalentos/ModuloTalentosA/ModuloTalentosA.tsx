...
<div className="grid grid-cols-2 h-fit w-screen overflow-hidden bg-linkIt-500 dark:bg-linkIt-200 dark:text-white p-[7%] pt-[17vh] lg:pt-[23vh] ">
 <div className="space-y-[5%] ">
        <h1 className="font-bold font-manrope xs:text-[1.3rem] ssm:text-[1.8rem] sm:text-[2rem] md:text-[2.3rem] w-[150%] ssm:w-[130%] sm:w-[115%] lg:w-[130%] lg:text-[3rem] xl:text-[3.5rem] xl:w-[112%] 2xl:text-[5rem] leading-tight ">{t('Conéctate con los mejores proyectos IT')}</h1>
      ...
      <img className="relative self-end bottom-5 w-[90%] left-[15%] xs:left-[30%] xs:w-[70%] ssm:w-[90%] ssm:bottom-0 ssm:left-[15%] lg:top-10 lg:w-[100%]  lg:left-[12%]" src="/Vectores/linkit-ilustracion-soy-talento-SVG_v02.svg" alt="computer" />
      </div>
  )
}
