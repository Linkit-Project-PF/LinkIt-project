    ...
    >
      ...
      <div className="grid grid-cols-2 h-fit w-screen overflow-hidden bg-linkIt-500 dark:bg-linkIt-200 dark:text-white md:pt-[17vh] lg:pt-[19vh] ">
        <div className="sm:mt-[5%] md:mt-0 md:space-y-[5%] md:p-[9%]  pl-[6%] min-[300px]:ml-[7px] min-[350px]:ml-2 min-[450px]:ml-3 min-[500px]:ml-3 ssm:ml-4 md:ml-0 ">
          <h1 className="hidden md:block font-bold font-manrope xs:text-[1.0rem] ssm:text-[1.8rem] sm:text-[2rem] md:text-[2.6rem] w-[150%] ssm:w-[130%] sm:w-[115%] lg:w-[130%] lg:text-[3rem] xl:text-[3.5rem] xl:w-[112%] 2xl:text-[5rem] leading-tight ">
        ...
        <img
          ...
          src="/2025/SoyTalento/ModuloA/linkit-slider-talento.webp"
          alt="IT Talent"
        />
      </div>
