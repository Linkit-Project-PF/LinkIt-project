...
<h1 className="text-[3vw] font-bold text-center font-manrope">{t('Cómo aplicar a')}</h1>
<div className="grid grid-cols-4">
        <h2 className="text-[1.3vw] font-manrope font-bold mt-[10%] justify-self-center">{t('Consulta nuestras vacantes')}</h2>
        <h2 className="text-[1.3vw] font-manrope font-bold mt-[10%] justify-self-center">{t('Aplica completando el formulario')}</h2>
        <h2 className="text-[1.3vw] font-manrope font-bold mt-[10%] justify-self-center">{t('Proceso de entrevistas')}</h2>
        <h2 className="text-[1.3vw] font-manrope font-bold mt-[10%] justify-self-center">{t('Consigue el trabajo de tus sueños')}</h2>
        <p className="text-center text-[1vw] mt-[5%] font-montserrat font-medium px-[15%]">{t('Tenemos posiciones abiertas en múltiples áreas de crecimiento.')}</p>
        <p className="text-center text-[1vw] mt-[5%] font-montserrat font-medium px-[15%]">{t('Selecciona tu posición ideal rellenando la solicitud en pocos clicks.')}</p>
        <p className="text-center text-[1vw] mt-[5%] font-montserrat font-medium px-[15%]">{t('Conoce en detalle la oportunidad y prepárate para los próximos pasos.')}</p>
        <p className="text-center text-[1vw] mt-[5%] font-montserrat font-medium px-[15%]">{t('Comienza a trabajar de forma remota y lleva tu carrera al siguiente nivel.')}</p>
