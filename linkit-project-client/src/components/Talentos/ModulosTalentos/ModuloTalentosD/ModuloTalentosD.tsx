    ...
    return (
            ...
            <div className="skewed-borderBH after:bg-linkIt-500 after:dark:bg-linkIt-200 hidden lg:block  p-[7%]">
                <div className="contentBH flex flex-col pb-[10%] ">
                    <h1 className="font-manrope font-bold self-center titles-size text-center justify-cente mb-[5%] text-white">{t('Nuestros servicios')}</h1>
                        <div className="">
                            <div className='grid grid-cols-3 mb-[3%] ml-[10%]'>
                            <h2 className="text-white font-bold subtitles-size font-manrope text-start w-[85%] xl:w-[80%] 1xl:w-[75%]">{t('Crecimiento y desarrollo')} </h2>
                            ...
                            <h2 className="text-white font-bold subtitles-size font-manrope text-start">{t('Trabajo remoto')}</h2>
                        ...
                        <div className='grid grid-cols-3 ml-[10%] mt-[3%]'>
                            <h2 className="text-white font-bold subtitles-size font-manrope text-start">{t('Facilidades de pago')}</h2>
