...
export default function Technologies() {
  ...
  return (
    <div className="p-[7%] dark:bg-linkIt-400">
      <h3 className="flex justify-center font-bold font-manrope titles-size xs:px-[9%] md:px-[12%] lg:px-[20%] xl:px-[27%] 1xl:px-[28%] 2xl:px-[34%] mb-[5%] dark:text-white text-center">
        {t("Talento especializado en más de 100 tecnologías")}
      </h3>

      <div className=" hidden lg:grid">
        <div className="flex flex-row flex-wrap justify-center items-center 2xl:px-[7%]">
          {technologies.map(({ name, logo, id }: Technology) => {
            return <CardTech key={id} id={id} name={name} logo={logo} />;
          })}
        </div>
      ...
      <div className="flex justify-center lg:hidden">
        <img
          className="relative rotate-180 w-[20px] cursor-pointer"
          onClick={handlePrev}
          src={grayArrow}
          alt="gray-Arrow"
        />
