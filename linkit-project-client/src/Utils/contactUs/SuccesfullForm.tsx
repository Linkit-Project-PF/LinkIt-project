  ...
  return (
    <div className="bg-linkIt-200 text-white font-montserrat overflow-hidden w-full px-[5%] pt-[11%] pb-[6%] flex justify-center">
      <div className=" text-center">
        ...
        <p className="font-montserrat  text-[0.8rem] mt-12 xs:mt-2 xs:text-[0.7rem] ssm:text-[0.9rem] sm:text-[1rem] lg:text-[1.5rem] md:text-[1.4rem] xl:text-[1.8rem] 2xl:text-[2rem] leading-tight mb-12 xs:mb-6">{t("En breve nos contactaremos contigo.")} <br />
