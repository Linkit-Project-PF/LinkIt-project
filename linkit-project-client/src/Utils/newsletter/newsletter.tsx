  ...
  return (
      <div className="bg-linkIt-300 pt-[7%] relative">
        <img 
          src={topLines} 
          alt="lines" 
          className="w-full absolute top-[17%] hidden lg:block"/>
        <img 
          src={topLinesMobile} 
          alt="lines" 
          className="w-full absolute top-[17%] lg:hidden"/>
        <h4
        ...
        <div className="relative w-full items-center justify-center flex">
          <img 
            src={bottomLines} 
            alt="lines" 
            className="absolute w-[75%] h-full top-[5%] left-[35%] hidden lg:block" />
          <img 
            src={bottomLinesMobile} 
            alt="lines" 
            className="absolute w-[75%] h-full top-[5%] left-[35%] lg:hidden" />
          <button
